...
export const partnerProcessSteps = [
  {
    title: 'Apply',
    partner: 'Share your profile, region, network, and the kind of businesses you can introduce.',
    jawrah: 'Jawrah Pixel verifies your application, intent, and fit for the Partner Network.',
    outcome: 'Your application enters review with a clear next step.',
  },
  {
    title: 'Get Approved',
    partner: 'Respond to any follow-up questions and confirm your communication details.',
    jawrah: 'We approve qualified partners, set the starting tier, and prepare dashboard access.',
    outcome: 'You become ready to refer clients with a professional partner path.',
  },
  {
    title: 'Refer Businesses',
    partner: 'Introduce businesses that need premium websites, ecommerce, AI automation, SEO, or digital systems.',
    jawrah: 'We handle discovery, proposal, design, engineering, deployment, and support.',
    outcome: 'The client receives a serious delivery team and you keep visibility into referral progress.',
  },
  {
    title: 'Earn Commission',
    partner: 'Stay connected while the referred project moves from proposal to payment.',
    jawrah: 'We log commissions, update payout status, and maintain the long-term client relationship.',
    outcome: 'You earn commission on approved paid projects and can grow into higher tiers.',
  },
] as const;
