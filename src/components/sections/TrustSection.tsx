      ...
      <div className="container mx-auto px-5 sm:px-6">
        <Reveal>
          <div className="text-center mb-16">
            ...
            <p className="text-brand-gray text-sm md:text-lg font-light max-w-2xl mx-auto">
          ...
          {stats.map((stat) => (
            <StaggerItem key={stat.label}>
              <div className="h-full p-5 sm:p-6 rounded-2xl bg-white/[0.02] border border-white/5 text-center group hover:border-brand-cyan/30 transition-all duration-500">
                ...
                <div className="text-[10px] font-mono uppercase tracking-widest text-brand-gray">{stat.label}</div>
              </div>
            </StaggerItem>
          ))}
        </StaggerContainer>
