...
export const REGION_SEO: Record<RegionSeoKey, RegionSeoMap> = {
  lk: {
    home: {
      ...BASE,
      path: '',
      title: 'Web Development Company in Sri Lanka | Jawrah Pixel',
      description: 'Jawrah Pixel is a Sri Lankan digital agency building custom websites, software, ecommerce platforms, mobile apps and SEO strategies for ambitious businesses.',
    ...
    services: {
      ...BASE,
      path: '/services',
      title: 'Web Development & Custom Software Services | Jawrah Pixel',
      description: 'Explore custom web development, business software engineering, ecommerce stores, mobile apps, UI/UX architecture, and technical SEO in Sri Lanka.',
      schemaType: 'Service',
      schemaData: { name: 'Web Development & Custom Software Services Sri Lanka', areaServed: 'Sri Lanka' },
      keywords: ['web development Sri Lanka', 'custom software development Sri Lanka', 'ecommerce development Sri Lanka', 'mobile app development Sri Lanka', 'SEO services Sri Lanka', 'digital agency Sri Lanka'],
    },
    contact: {
      ...BASE,
      path: '/contact',
      title: 'Web Development Company Sri Lanka | Contact Jawrah Pixel',
      description: 'Submit your project brief or schedule a strategic consultation with Jawrah Pixel for custom web development, software, ecommerce, or SEO in Sri Lanka.',
    },
    agents: {
      ...BASE,
      path: '/partner',
      title: 'Become a Jawrah Pixel Partner | Sri Lanka',
      description: 'Join the Jawrah Pixel partner network in Sri Lanka and collaborate on digital systems and web engineering projects.',
    },
    about: {
      ...BASE,
      path: '/about',
      title: 'About Jawrah Pixel | Digital Agency & Software Engineering Sri Lanka',
      description: 'Jawrah Pixel is a Sri Lankan digital agency specializing in custom websites, business operations software, ecommerce platforms, and digital transformation.',
    },
    leadership: {
      ...BASE,
      path: '/leadership',
      title: 'Leadership | Founder & Co-Founder | Jawrah Pixel',
      description: 'Meet the team behind Jawrah Pixel — founder Abdurrahman Shafie and co-founder Jaweria Hafeez — engineering custom digital systems across Sri Lanka and international markets.',
      keywords: ['JawrahPixel leadership', 'Jawrah Pixel founders', 'digital agency Sri Lanka'],
    },
    process: {
      ...BASE,
      path: '/process',
      title: 'Our Engineering Process | Jawrah Pixel Sri Lanka',
      description: 'Discover how Jawrah Pixel plans, architects, designs, engineers, tests, and deploys custom websites and business software platforms.',
    },
    pricing: {
      ...BASE,
      path: '/pricing',
      title: 'Pricing & Project Packages | Jawrah Pixel Sri Lanka',
      description: 'Transparent investment ranges for custom websites, ecommerce stores, business software systems, and technical SEO in Sri Lanka.',
      keywords: ['Website Pricing Sri Lanka', 'Web Development Packages', 'Ecommerce Pricing', 'Business System Pricing'],
    },
    caseStudies: {
      ...BASE,
      path: '/case-studies',
      title: 'Digital Agency Portfolio Sri Lanka | Jawrah Pixel',
      description: 'Explore verified custom software engineering, business operations platforms, web applications, and digital systems built by Jawrah Pixel.',
    },
    blog: {
      ...BASE,
      path: '/blog',
      title: 'Digital Systems & SEO Insights | Jawrah Pixel Blog',
      description: 'Authoritative guides on web development costs, custom software architecture, ecommerce planning, and technical SEO for Sri Lankan businesses.',
