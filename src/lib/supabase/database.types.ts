    ...
    Tables: {
      profiles: {
        Row: {
          ...
          agent_status: 'pending' | 'under_review' | 'interview' | 'approved' | 'rejected' | 'suspended' | null;
          created_at: string;
          updated_at: string;
        };
        Insert: {
      ...
      agent_applications: {
        Row: {
          ...
          message: string | null;
          status: 'pending' | 'under_review' | 'interview' | 'approved' | 'rejected' | 'suspended';
